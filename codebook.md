...
### Analysis process
 ...
 - Finally, the summary dataset is written to a file, `raw_data_summary.txt`.
...
Detailed information on the experiment and the data can be found in the `README.txt` and `features_info.txt` files included in the experiment data [zip file](http://d396qusza40orc.cloudfront.net/getdata/projectfiles/FUCI%20HAR%20Dataset.zip) or find more information on the dataset [homepage](http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones).
